script_key = "LAIRGSIiahsCDYLDjjNvqNHZZxZTbFaO"; -- // The key you were granted.
...
getgenv().Evolution = {
    ...
    Global = {
        ...
        AutoPredict = true, -- // Auto Prediction based on ping
        Prediction = 0.155, -- // Prediction velocity
        AntiGroundShot = true, -- // Prevents you from shooting ground
        UnlockOnKO = true, -- // Unlocks on KO
    },
    SilentAim = {
        Enabled = true, -- // Enables Silent aim
        TargetBone = "HumanoidRootPart", -- // Bone that is targeted you
        ...
        NearestCursorPoint = true, -- // Ignores target bone and selects closest part to mouse
    ...
    CamLock = {
        ...
        TargetBone = "HumanoidRootPart", -- // Bone that is targeted
        AllowNotifications = false, -- // Allows notifications for camlock
        Key = "Q", -- // Key to lock onto target
        UseSmoothness = true, -- // Enable Smoothness
        Smoothness = 0.092, -- // Self Explained 
        DetectAntiAim = { -- // Enables Resolver when anti aim detected
            Enabled = true,
            Min = -40,
            Max = 40
    ...
    Resolver = {
        AimViewBypass = true, -- // Bypasses aim viewer
        DesyncResolver = true, -- // Resolves all anti aims.
    },
    GunFOV = {
    ...
    Settings = {
        AutoLowGFX = true, -- // Low Graphics (cannot change once executed)
        DisableShadows = true, -- // Disables shadows (better performance)
